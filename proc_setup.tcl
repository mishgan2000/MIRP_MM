...
#
#  File     proc_setup.tcl (Fri Feb 02 16:02:53 2024)
#
...
#  with the '-tclbatch proc_setup.tcl' option.
...
proc PrintHelpInformation {} {
  ...
  puts "**********************************************************************"
  puts "***"
  puts "***   Simulation Setup Macros (proc_setup.tcl)"
  puts "***"
  puts "***   w   =>  set up signal tracing for the ISE Simulator waveform"
  puts "***           viewer (edit signal lists in proc_wave.tcl)"
  puts "***"
