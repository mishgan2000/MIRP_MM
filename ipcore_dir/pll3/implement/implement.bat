...
xst -ifn xst.scr
move pll3_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll3_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll3_exdes.ucf pll3_exdes

echo 'Running map'
map -timing -pr b pll3_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm pll3_exdes -w routed.ncd routed.vhd
cd ..
