...
xst -ifn xst.scr
move clock_768_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clock_768_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clock_768_exdes.ucf clock_768_exdes

echo 'Running map'
map -timing -pr b clock_768_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clock_768_exdes -w routed.ncd routed.vhd
cd ..
