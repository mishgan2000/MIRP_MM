...
-- Date:              Fri Jan 26 16:03:18 2024 (by Create and Import Peripheral Wizard)
...
begin
  ...
  -- Duty cycle is controlled by the software register
  --duty_cycle <= slv_reg0(7 downto 0); 
  --duty_cycle <= slv_reg0(7 downto 0); 
  --pwm_out(7 downto 0) <= duty_cycle(7 downto 0);
  --to_fpga(15 downto 0) <= slv_reg0(15 downto 0); 
...
--  end process counter;
  ...
  -- Enable the output for duty cycle selected
          ...
          when "1" =>
            for byte_index in 0 to (C_SLV_DWIDTH/8)-1 loop
              if ( Bus2IP_BE(byte_index) = '1' ) then
				...
				to_fpga(31 downto 0) <= slv_reg0(31 downto 0);
          when others => null;
        end case;
      end if;
    end if;
  ...
  begin
    ...
    case slv_reg_read_sel is
      --when "1" => slv_ip2bus_data <= slv_reg0;
		when "1" => slv_ip2bus_data(31 downto 0) <= from_fpga(31 downto 0);
