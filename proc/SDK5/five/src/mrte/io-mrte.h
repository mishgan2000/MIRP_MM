...
#define ERROR_RX_TIMEOUT			(9)
#define ERROR_TM_SOCKET_CLOSE		(10)
...
#define ERROR_SPI_READ_FLASH		(0x14)
#define ERROR_SPI_WRITE_FLASH		(0x15)
#define ERROR_SPI_COPY_FLASH		(0x16)
#define ERROR_SPI_SET_PROTECT		(0x17)
#define ERROR_SPI_IS_BUSY			(0x18)
...
////////////////////////////////////
typedef portBASE_TYPE (*on_can_recv_message_hook_ptr)(const canmsg_t * p_can_data);
...
//Should be described somewhere in using project
extern u16 get_serial_num(void);
extern void notify_can_reset_mrte(void);

//Fine tuning of mrte sending process
//Default block time equals 10 time quants of FreeRTOS
void define_mrte_block_send_time(u32 block_time);

//Send, store and load CAN_ID via these functions
