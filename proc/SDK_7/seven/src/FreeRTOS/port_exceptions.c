...
__attribute__((noreturn)) void vApplicationExceptionRegisterDump( xPortRegisterDump *xRegisterDump )
{
	( void ) xRegisterDump;
...
__attribute__((noreturn)) void vPortExceptionHandler( void *pvExceptionID )
{
#if 0
