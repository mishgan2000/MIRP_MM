...
//    my_timer_continuos_start();
    ...
    */
    ...
    xTaskCreate( mt_2, ( const char * )"MT_2", 1024, NULL, 0, NULL );
...
/*
    ...
    */
    ...
    //*/
	for (Index = 0; Index < PAGE_SIZE; Index++) {WriteBuffer[sizeof(Address) + Index] = (Index + 1) & 0xFF;
		ReadBuffer[Index] = 0;
	}
	...
	for (Index = 0; Index < 16; Index++) {
		if (ReadBuffer[Index] != WriteBuffer[Index + sizeof(Address)]) {return XST_FAILURE;	}
		ReadBuffer[Index] = 0;
	}
   */
	return XST_SUCCESS;
